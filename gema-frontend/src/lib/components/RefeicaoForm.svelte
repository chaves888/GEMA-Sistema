...
<form on:submit|preventDefault={handleSubmit} class="flex flex-col h-full">
  <div class="border-b pb-4 mb-6">
    ...
    <p class="text-gray-500 capitalize mt-1 text-sm md:text-base">
  ...
  <div class="flex-1 overflow-y-auto pr-1 space-y-6">
      ...
      <div>
        ...
        {:else}
          ...
          <div class="border border-gray-200 rounded-lg max-h-60 overflow-y-auto p-3 space-y-2 custom-scrollbar">
  ...
  <div class="mt-6 flex flex-col-reverse sm:flex-row justify-end gap-3 border-t pt-6">
    <button
      type="button"
