...
<div class="min-h-screen py-10 px-6 space-y-8 bg-gradient-to-b from-gray-50 to-gray-100 animate-fadeIn">
	<div
		class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white/70 backdrop-blur-md p-6 rounded-xl shadow-sm border border-gray-100"
	>
		<div>
			<h1
